...
export default defineComponent({
  ...
  setup(_, { emit }) {
    ...
    const scrollContainer: Ref<(ComponentPublicInstance & HTMLElement) | null> = ref(null)
    const scrollWrapper = computed(() => {
      return scrollContainer.value && (scrollContainer.value?.$refs.wrap as HTMLElement)
    })
